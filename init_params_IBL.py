...
def get_reproject_images(joined_list_2d, path_images, num_cameras, i=0):
    fig, ax = plt.subplots()
    ...
    plot_image_labels(
        img, joined_list_2d, i, color_list_2d, ax=ax, top_img_height=img_height[0], pad=0
    )
        ...
        html.Div(
            [
                ...
                html.Div(
                    div_images,
                    id="images",
                    style={"float": "center", "marginTop": 100, "marginBottom": 100},
                ),
            ],
            className="row",
        ),
        html.Div(trans_sliders, style={"float": "bottom", "marginTop": 200}),
        html.Div(
            rot_sliders,
...
def update_fig(cam_val, x_trans, y_trans, z_trans, x_rot, y_rot, z_rot, n_clicks):
    ...
    if n_clicks != N_CLICKS:
        ...
        reproj_path = get_reproject_images(joined_list_2d, path_images, len(cam_group.cameras))
